...
private enum LocalMLXSmokeRunner {
    ...
    static func runIfRequested() async {
        ...
        do {
            let result = try await AgentKitMLXModelProvider.shared.chat(
                message: prompt,
