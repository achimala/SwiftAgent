...
public enum SwiftAgentLocalMLXModels {
...
extension HermesAgentConfiguration {
    public static func localMLX(
        model: String = SwiftAgentLocalMLXModels.qwen35_2BOptiQ4Bit,
        maxTokens: Int = 128,
...
public struct SwiftAgentLocalLLMConfiguration: Sendable {
    public var modelID: String
    public var maxTokens: Int
    public var temperature: Float

    public init(
        modelID: String = SwiftAgentLocalMLXModels.qwen35_2BOptiQ4Bit,
        maxTokens: Int = 128,
...
public actor SwiftAgentMLXModelProvider: SwiftAgentModelProvider {
    ...
    public func complete(
        ...
        let configuration = SwiftAgentLocalLLMConfiguration(
            modelID: (model?.isEmpty == false ? model! : SwiftAgentLocalMLXModels.qwen35_2BOptiQ4Bit),
            maxTokens: maxTokens,
            temperature: temperature
        )
        let tools = (requestObject["tools"] as? [[String: Any]] ?? [])
            .compactMap(Self.toolSpec(from:))
        let emitProviderDeltas = requestObject["swiftagent_emit_provider_deltas"] as? Bool ?? true
    ...
    public func chat(
        message: String,
        configuration: SwiftAgentLocalLLMConfiguration,
        tools: [ToolSpec] = [],
    ...
    private func session(
        for configuration: SwiftAgentLocalLLMConfiguration,
        onEvent: @escaping @Sendable (SwiftAgentEvent) -> Void,
        started: Date
...
public extension HermesAgent {
    static func localMLX(
        ...
        modelProvider: SwiftAgentMLXModelProvider = SwiftAgentMLXModelProvider()
    ) throws -> HermesAgent {
