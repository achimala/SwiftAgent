...
public extension HermesAgentConfiguration {
    static func foundationModels(
        ...
        HermesAgentConfiguration(
            ...
            contextLength: SwiftAgentFoundationModels.hermesContextLength,
...
@available(iOS 26.0, macOS 26.0, visionOS 26.0, *)
public actor SwiftAgentFoundationModelsProvider: SwiftAgentModelProvider {
    private let configuration: SwiftAgentFoundationModelsConfiguration

    public init(configuration: SwiftAgentFoundationModelsConfiguration = .init()) {
...
public extension HermesAgent {
    static func foundationModels(
        ...
        enableMemory: Bool = true,
        sourceURL: URL? = nil,
        providerConfiguration: SwiftAgentFoundationModelsConfiguration = .init()
    ) throws -> HermesAgent {
        try HermesAgent.localProvider(
            ...
            sourceURL: sourceURL,
            modelProvider: SwiftAgentFoundationModelsProvider(configuration: providerConfiguration)
        )
    }
}
