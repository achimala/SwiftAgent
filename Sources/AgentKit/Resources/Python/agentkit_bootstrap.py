...
from agentkit_ios_tool_bridge import install_ios_tool_bridge
from agentkit_local_provider_adapter import (
    configure_agentkit_local_provider_client,
    ensure_agentkit_model_config,
    is_agentkit_local_model_base_url,
...
def _get_agent():
    ...
    if _agent is None:
        ...
        ensure_agentkit_model_config(_agent_config)
        ...
        configure_agentkit_local_provider_client(run_agent, _agent_config)
        emit_agent_step("agentkit_local_provider_client_configured")
